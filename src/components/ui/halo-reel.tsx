...
function WheelCard({
  ...
  return (
    <motion.div
      ...
      className="absolute overflow-hidden rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.7)] border border-white/[0.08]"
    >
      {item.src ? (
        <img
          src={item.src}
        ...
        <div
          className="flex h-full w-full flex-col items-center justify-center gap-1 bg-[#12151f] p-3 text-center text-white"
          style={{
